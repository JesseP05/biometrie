...
#### Wat hebben we nodig?
- meetlint
- spreadsheet om data op te schrijven
- proefpersonen
...
5. Meet daarna de armlengte.
6. Laat de arm op schouderhoogte uitstrekken.
8. Laat de tweede meter dezelfde persoon ook meten.
...
ggplot(data = res_data,
    ...
    theme_minimal()                             # beetje schoner plotje maken
```
Uit de plot komt dat er geen groot verschil zit tussen de ratios, maar het blijkt wel dat mannen vaker even lange armen hebben. 

De hypothese is "Er is een verschil tussen de verhouding van armlengte tot lichaamslengte bij mannen en vrouwen.".

In dit geval is de hypothese bewezen, omdat het gemiddelde van de mannen hoger ligt dan bij de vrouwen.
